...
void comm_can_send_status1(uint8_t id, bool replace) {
	...
	buffer_append_int16(buffer, (int16_t)(mc_interface_get_tot_current_filtered() * 1e3), &send_index);
...
void comm_can_send_status4(uint8_t id, bool replace) {
	...
	buffer_append_int16(buffer, (int16_t)(mc_interface_get_tot_current_in_filtered() * 1e3), &send_index);
