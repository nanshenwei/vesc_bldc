...
#ifndef HW_CAPSTONE_CORE_H_
#define HW_CAPSTONE_CORE_H_
...
#define NTC_RES_MOTOR(adc_val)	((4095.0 * 10000.0) / adc_val - 10000.0) // Motor temp sensor on low side
...
/*
typedef struct {
	stm32_gpio_t *nss_gpio;3
	int nss_pin;
	stm32_gpio_t *sck_gpio;1
	int sck_pin;
	stm32_gpio_t *mosi_gpio;0
	int mosi_pin;
	stm32_gpio_t *miso_gpio;2
	int miso_pin;
	mutex_t mutex;
} spi_bb_state;
 */
...
#define MCCONF_FOC_DT_US				0.125 // Microseconds for dead time compensation
#endif
#ifndef MCCONF_L_CURRENT_MAX
#define MCCONF_L_CURRENT_MAX			1.0	// Current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_CURRENT_MIN
#define MCCONF_L_CURRENT_MIN			-1.0	// Current limit in Amperes (Lower)
#endif
#ifndef MCCONF_L_IN_CURRENT_MAX
#define MCCONF_L_IN_CURRENT_MAX			1.0	// Input current limit in Amperes (Upper)
#endif
#ifndef MCCONF_L_IN_CURRENT_MIN
#define MCCONF_L_IN_CURRENT_MIN			-0.01	// Input current limit in Amperes (Lower)
#endif
#ifndef MCCONF_L_IN_CURRENT_MAP_START
#define MCCONF_L_IN_CURRENT_MAP_START	0.35		// Input current to Q axis current limit map start
#endif
...
#define MCCONF_L_MAX_ABS_CURRENT		3.0	// The maximum absolute current above which a fault is generated
#endif
#ifndef MCCONF_L_MIN_VOLTAGE
#define MCCONF_L_MIN_VOLTAGE			36.0		// Minimum input voltage
#endif
#ifndef MCCONF_L_MAX_VOLTAGE
#define MCCONF_L_MAX_VOLTAGE			320.0	// Maximum input voltage
#endif
#ifndef MCCONF_L_MIN_DUTY
#define MCCONF_L_MIN_DUTY				0.003	// Minimum duty cycle
#endif
#ifndef MCCONF_L_MAX_DUTY
#define MCCONF_L_MAX_DUTY				0.25	// Maximum duty cycle
#endif
// Current control parameters
#ifndef MCCONF_CC_GAIN
#define MCCONF_CC_GAIN					0.0046 // 0.0023	// Current controller error gain
#endif
#ifndef MCCONF_CC_MIN_CURRENT
#define MCCONF_CC_MIN_CURRENT			0.01	// Minimum allowed current
#endif
#ifndef MCCONF_CC_STARTUP_BOOST_DUTY
#define MCCONF_CC_STARTUP_BOOST_DUTY	0.005	// The lowest duty cycle to use in current control mode (has to be > MCPWM_MIN_DUTY_CYCLE)
#endif
#ifndef MCCONF_CC_RAMP_STEP
#define MCCONF_CC_RAMP_STEP				0.01 	// 0.001	// Maximum duty cycle ramping step in CC mode
#endif
// FOC
#ifndef MCCONF_FOC_CURRENT_KP
#define MCCONF_FOC_CURRENT_KP			3.00
#endif
#ifndef MCCONF_FOC_CURRENT_KI
#define MCCONF_FOC_CURRENT_KI			0.3
#endif

// Setting limits
#define HW_LIM_CURRENT			-3.5, 3.5
#define HW_LIM_CURRENT_IN		-2.0, 10.0
#define HW_LIM_CURRENT_ABS		0.0, 7
#define HW_LIM_VIN				36.0, 350.0
#define HW_LIM_ERPM				-200e3, 200e3
#define HW_LIM_DUTY_MIN			0.0, 0.1
#define HW_LIM_DUTY_MAX			0.0, 0.99
#define HW_LIM_TEMP_FET			-40.0, 110.0

#endif /* HW_CAPSTONE_CORE_H_ */
